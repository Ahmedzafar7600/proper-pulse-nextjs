...
const PropertyCard = ({ property }) => {
  ...
  return (
    <div className="rounded-xl shadow-md relative">
      <Image
        src={propertyLocal.images?.[0] || "/default-property.jpg"} // ✅ Use fallback image
        alt={propertyLocal.name || "Property Image"}
        width={0}
        height={0}
        sizes="100vw"
      ...
      <div className="p-4">
        <div className="text-left md:text-center lg:text-left mb-6">
          <div className="text-gray-600">{propertyLocal.type}</div>
          <h3 className="text-xl font-bold">{propertyLocal.name}</h3>
        </div>
        ...
        <div className="flex flex-col lg:flex-row justify-between mb-4">
          <div className="flex align-middle gap-2 mb-4 lg:mb-0">
            ...
            <span className="text-orange-700">
              {propertyLocal.location?.city} {propertyLocal.location?.state}
            </span>
          </div>
          <Link
